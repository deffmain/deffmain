...
**`Engenharia de Software | Desenvolvedor de Software`**

Sou estudante de **Engenharia de Software**, apaixonado por tecnologia e pelo desenvolvimento de soluções que possam resolver problemas reais.
...
Tenho dedicado parte dos meus estudos ao **aprofundamento em Inteligência Artificial**, buscando compreender não apenas como utilizar ferramentas de IA, mas também seus fundamentos, possibilidades de aplicação e impactos no desenvolvimento de software.
